...
companys = store.get_usa_company()
for index, company in companys.iterrows():
    ...
    try:
        nasdaq_daily = web.DataReader(symbol, start='1/1/2015', end='1/17/2019', data_source='yahoo')
        ...
        nasdaq_daily.to_sql('usa_core_daily', engine, if_exists='append')
    except:
